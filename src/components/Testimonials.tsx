                ...
                <div className="relative grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {testimonials.map((t, i) => (
                        <motion.div
                            ...
                            hover:border-primary/30 transition-all duration-300 hover:bg-surface-light
                            hover:shadow-xl hover:shadow-dark-900/50 hover:-translate-y-1">
                            ...
                            <div className="flex items-center gap-3 pt-5 border-t border-surface-border">
                                <div className={`w-10 h-10 rounded-full bg-linear-to-br ${t.avatarBg} flex items-center 
                                justify-center text-white text-sm font-bold`}>{t.avatar}</div>
                                <div>
