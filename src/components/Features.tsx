import {BookOpen, Code2, Laptop, MessageCircle, Rocket, Shield, Trophy, Users, Zap,} from "lucide-react";
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {features.map((feature, i) => (
                        <motion.div
                            ...
                            className={`group relative p-7 rounded-2xl bg-surface border border-surface-border 
                            ${feature.borderColor} transition-all duration-300 hover:bg-surface-light hover:shadow-xl
                            hover:shadow-dark-900/50 hover:-translate-y-1`}
                        >
                            <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl ${feature.bg} 
