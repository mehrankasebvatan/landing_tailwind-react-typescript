                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    {stats.map((stat, i) => (
                        <motion.div
                            ...
                            className="relative group text-center p-8 rounded-2xl bg-surface border
                             border-surface-border hover:border-primary/30 transition-all duration-300
                             hover:shadow-xl hover:shadow-dark-900/50">
                            <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl ${stat.bg}
                            ...
                            <div className="text-base text-text-primary font-semibold mb-1">{stat.label}</div>
